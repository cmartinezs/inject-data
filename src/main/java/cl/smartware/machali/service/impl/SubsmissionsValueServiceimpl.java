...
public class SubsmissionsValueServiceimpl implements SubmissionsValueService
{
	...
	private String mapFieldValue(SubmissionsValueFieldNames field, CSVItem item)
	{
		...
		{
			String iframe = "<iframe width=\"600\" height=\"450\" frameborder=\"0\" style=\"border:0\" src=\"https://www.google.com/maps/embed/v1/place?key= {0}&q={1}\" allowfullscreen></iframe>";
			value = MessageFormat.format(iframe, apiKey, value);
		}
